...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const ports = [
        ...
        },
        {
            CITY: "Heianza",
            STATE:
                'Japan does not seem to correspond to a known city or town in Japan. If you might be referring to a misnomer or a less known place, I would suggest verifying the correct name. However, if intended to match well-known cities, consider "Himeji, Hyogo" as an example.',
            COUNTRY: "Japan",
            LATITUDE: 26.4,
            LONGITUDE: 127.97,
        },
    ...
    // Loop through each port to create a marker on the map
    ports.forEach((port) => {
        const { CITY, COUNTRY, LATITUDE, LONGITUDE } = port;
        
        // Check if the latitude and longitude exist and Create a circle marker
        if (LATITUDE && LONGITUDE) {
            ...
            // Tooltip to the marker
            marker.bindTooltip(`<b>${CITY}, ${COUNTRY}</b>`, {
                permanent: false,
                direction: "top",
                offset: [0, -8],
            });
